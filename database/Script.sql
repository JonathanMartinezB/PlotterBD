...
-- Base de datos: `weber`
--
CREATE DATABASE IF NOT EXISTS `plotter` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `plotter`;
...
INSERT INTO `usuarios` (`id`, `nombres`, `apellidos`, `tipo_documento`, `documento`, `telefono`, `direccion`, `user`, `password`, `rol`, `estado`, `fecha_registro`) VALUES
(1, 'Diego Alonso', 'Ojeda Medina', 'C.C', 12312312, 311324325, 'Transveral 27 15 -35',  'daom89', '123456', 'Administrador', 'Activo', '2020-07-27 00:00:00'),
(2, 'Juan Pablo', 'Garcia Gonzales', 'C.C', 46357159, 3118864151, 'Transveral 27 18-34', NULL, NULL, 'Cliente', 'Activo', '2020-07-27 00:00:00'),
(3, 'Juan Ricardo', 'Gonzales', 'C.C', 18328382, 42534647, 'Cra 27 N 2F - 05', NULL, NULL, 'Empleado', 'Activo', '2020-07-27 00:00:00');
...
CREATE TABLE IF NOT EXISTS `compras` (
                                        ...
                                        `estado` enum('Activo','Inactivo') COLLATE utf8mb4_unicode_ci NOT NULL,
                                        PRIMARY KEY (`id`),
                                        KEY `fk_compras_Usuarios1_idx` (`cliente_id`),
                                        KEY `fk_compras_Usuarios2_idx` (`empleado_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Filtros para la tabla `detalle_compras`
--
ALTER TABLE `detalle_compras`
    ADD CONSTRAINT `fk_detalle_compras_producto1` FOREIGN KEY (`producto_id`) REFERENCES `productos` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
    ADD CONSTRAINT `fk_detalle_compras_compras1` FOREIGN KEY (`compras_id`) REFERENCES `compras` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

-- Filtros para la tabla `compras`
ALTER TABLE `compras`
    ADD CONSTRAINT `fk_compras_Usuarios1` FOREIGN KEY (`cliente_id`) REFERENCES `usuarios` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
    ADD CONSTRAINT `fk_compras_Usuarios2` FOREIGN KEY (`empleado_id`) REFERENCES `usuarios` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
