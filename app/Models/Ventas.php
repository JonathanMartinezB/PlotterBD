...
class Ventas extends BasicModel
{
    ...
    {
        $result = $this->insertRow("INSERT INTO plotter.ventas VALUES (NULL, ?, ?, ?, ?, ?, ?)", array(
                $this->numero_serie,
    ...
    {
        $result = $this->updateRow("UPDATE plotter.ventas SET numero_serie = ?, cliente_id = ?, empleado_id = ?, fecha_venta = ?, monto = ?, estado = ? WHERE id = ?", array(
                $this->numero_serie,
                $this->cliente_id->getId(),
                $this->empleado_id->getId(),
