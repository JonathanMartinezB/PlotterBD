...
<html>
<head>
    <title><?= $_ENV['TITLE_SITE'] ?> | Editar Compras</title>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-info">
                            <div class="card-header">
                                <h3 class="card-title"><i class="fas fa-box"></i>&nbsp; Información de la compra</h3>
                            ...
                            <?php if (!empty($_GET["id"]) && isset($_GET["id"])) { ?>
                                ...
                                if (!empty($DataCompra)) {
                                    ...
                                    <div class="card-body">
                                        <!-- form start -->
                                        <form class="form-horizontal" method="post" id="frmEditCompra"
                                              name="frmEditCompra"
                                              action="../../../app/Controllers/ComprasController.php?action=edit">
                                            <input id="id" name="id" value="<?php echo $DataCompra->getId(); ?>"
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input required type="text" class="form-control" id="numero_serie"
                                                           name="numero_serie" value="<?= $DataCompra->getNumeroSerie(); ?>"
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input required type="text" class="form-control" id="cliente_id"
                                                           name="cliente_id" value="<?= $DataCompra->getClienteId(); ?>"
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input required type="text" class="form-control" id="empleado_id"
                                                           name="empleado_id" value="<?= $DataCompra->getEmpleadoId(); ?>"
