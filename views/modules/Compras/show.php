...
<html>
<head>
    <title><?= $_ENV['TITLE_SITE'] ?> | Datos de la Compra</title>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-green">
                            <?php if (!empty($_GET["id"]) && isset($_GET["id"])) {
                                $DataCompras = ComprasController::searchForID($_GET["id"]);
                                if (!empty($DataCompras)) {
                                    ?>
                                    <div class="card-header">
                                        <h3 class="card-title"><i class="fas fa-shopping-cart"></i> &nbsp; Ver
                                            Información de la Compra<?= $DataCompras->getNumeroSerie() ?>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="text-muted">
                                            <?= $DataCompras->getNumeroSerie() . "-" . $DataCompras->getId(); ?>
                                        </p>
                                        <hr>
                                        <strong><i class="fas fa-user-ninja mr-1"></i> Cliente</strong>
                                        <p class="text-muted"><?= $DataCompras->getClienteId()->getNombres() . ": " . $DataCompras->getClienteId()->getApellidos() ?></p>
                                        <hr>
                                        <strong><i class="far fa-user mr-1"></i> Empleado</strong>
                                        <p class="text-muted"><?= $DataCompras->getEmpleadoId()->getNombres() . ": " . $DataCompras->getEmpleadoId()->getApellidos() ?></p>
                                        <hr>
                                        <strong><i class="far fa-calendar mr-1"></i> Fecha Compra</strong>
                                        <p class="text-muted"><?= $DataCompras->getFechaVenta(); ?></p>
                                        <hr>
                                        <strong><i class="fas fa-money-bill mr-1"></i> Monto</strong>
                                        <p class="text-muted"><?= $DataCompras->getMonto(); ?></p>
                                        <hr>
                                            ...
                                            <div class="col-auto mr-auto">
                                                <a role="button" href="index.php" class="btn btn-success float-right"
                                                   style="margin-right: 5px;">
                                                    <i class="fas fa-tasks"></i> Gestionar Compras
                                                </a>
                                            </div>
                                            <div class="col-auto">
                                                <a role="button" href="create.php" class="btn btn-primary float-right"
                                                   style="margin-right: 5px;">
                                                    <i class="fas fa-plus"></i> Crear Compras
                                                </a>
                                            </div>
                                        </div>
                                    </div>
